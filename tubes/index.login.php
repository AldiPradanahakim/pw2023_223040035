...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha512-fm1DrjrMo+7Xr21Epl+Y5kDCq9hF5efWjIOgbZIz3BX66lg39loTSPBUVrFTC0mI/3HTzLJqmcC8NebihozBrA=="
        crossorigin="anonymous" />
    <link href="https://fonts.googleapis.com/css2?family=Pacifico&family=Rubik:ital,wght@0,400;1,500&display=swap"
        rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary  fixed-top mb-5">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <form action="admin/partials/search.login.php" method="get" class="search d-flex ms-auto my-4"
                        role="search">
                        <input name="keyword" id="keyword" class="search-input form-control me-2 rounded-pill"
                            type="search" placeholder="Cari berita..." aria-label="Search" autofocus
                            autocomplete="off" />
                        <button name="cari" id="tombol-cari" class="search-btn btn btn-light rounded-pill"
                            type="submit">
        ...
        <div id="carouselExampleInterval" class="carousel slide pt-5" data-bs-ride="carousel">
            ...
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                    class="active thumbnail" aria-current="true" aria-label="Slide 1" ata-bs-interval="10000">
                    <img src="img/drawing.jpg" class="d-block w-100" alt="">
                </button>
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                    class="thumbnail " aria-label="Slide 2" ata-bs-interval="2000">
                    <img src="img/menko airlangga.jpg" class="d-block w-100" alt="">
                </button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <h3>Titik News</h3>
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.1902773276856!2d107.5919273!3d-6.867788699999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e71cb76767dd%3A0x56fb391efe22f815!2s24%20E!5e0!3m2!1sid!2sid!4v1685733864647!5m2!1sid!2sid"
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                            <ul class="kategori list-unstyled">
                                <li class="mb-2" style="padding-right: 5px;"><a
                                        href="https://travel.detik.com/">Travel</a></li>
                                <li class="mb-2" style="padding-right: 5px;"><a href="https://food.detik.com/">Food</a>
                                </li>
                                <li class="mb-2" style="padding-right: 5px;"><a
                                        href="https://health.detik.com/">Health</a></li>
