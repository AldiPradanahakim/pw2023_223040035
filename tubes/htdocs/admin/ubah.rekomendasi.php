...
$recommendations = query("SELECT * FROM news WHERE id = $id")[0];
        ...
        <div class="container">
            ...
            <div class="row">
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $recommendations["id"]; ?>">
                    <input type="hidden" name="gambar" value="<?= $recomendations["gambar"]; ?>">
                    <ul>
                        <li>
                            <label for="title">title :</label>
                            <input type="text" name="title" id="title" value="<?= $recommendations["tittle"]; ?>">
                        </li>
                        <li>
