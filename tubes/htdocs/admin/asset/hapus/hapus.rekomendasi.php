...
$recommendations = query("SELECT n.*,k.*, n.id as id_berita
FROM news n
            ...
            <section id="about" class="about section">
                <div class="container">
                    <div class="section-title">
                        <h2>Hapus Rekomendasi Untuk Anda</h2>
                    </div>
                    <table cellpadding="10" cellspacing="0">
                        ...
                        <?php foreach ($recommendations as $row) : ?>
                            <tr class="isi">
                                ...
                                <td class="uil">
                                    <a href="../../hapus.rekomendasi.php?id=<?= $row["id_berita"]; ?>" onclick="return confirm('yakin?')"><i class="uil uil-times-circle"></i></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
