    ...
    <div class="main-container" id="container">
        <div class="aside no-print">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="asset/tampilan/tampilanubah.php" class="active"><i
                            class="uil uil-edit"><span>Edit</span></i></a>
                </li>
                <li>
                    <a href="#" onclick="toggleDropdown('dropdown1')"><i
                            class="uil uil-list-ul"><span>List</span></i></a>
                </li>
                <li>
